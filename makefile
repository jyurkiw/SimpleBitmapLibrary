...
all: Pixel_24.o PixelArray.o Pixel24Test.o PixelArrayTest.o RunUnitTests.o
	g++ -g -O0 -fno-inline build/Pixel_24.o build/PixelArray.o build/Pixel24Test.o build/PixelArrayTest.o build/RunUnitTests.o -lcppunit -o bin/RunUnitTests

#MAKE Pixel_24.o
Pixel_24.o: src/Pixel_24/Pixel_24.cpp
	g++ -g -O0 -fno-inline -c -Isrc src/Pixel_24/Pixel_24.cpp -o build/Pixel_24.o 
...
Pixel24Test.o: src/unit/Pixel24Test.cpp
	g++ -g -O0 -fno-inline -c -Isrc -Isrc/Pixel_24 -lcppunit src/unit/Pixel24Test.cpp -o build/Pixel24Test.o
...
RunUnitTests.o: src/unit/RunUnitTests.cpp
	g++ -g -O0 -fno-inline -c -Isrc -Isrc/Pixel_24 -Isrc/PixelArray -lcppunit src/unit/RunUnitTests.cpp -o build/RunUnitTests.o
